...
public class OctetString extends ASNObject {
	...
	public void print() {
		...
		if (!isOptional || isSelected) {
			...
			for (int i = 0; i < octetString.length; i++) {
				builder.append(String.format("0x%02x ", octetString[i]));
			}
	...
	/**
	 * Convert octet string to byte array. For example, both strings "test" and
	 * "0x74657374" will result in equals byte arrays.
	 */
