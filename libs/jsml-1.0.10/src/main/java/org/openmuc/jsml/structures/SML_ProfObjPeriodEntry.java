...
public class SML_ProfObjPeriodEntry extends Sequence {
	...
	public SML_ProfObjPeriodEntry(SML_Time valTime, Unsigned64 status, List_of_SML_ValueEntry value_List, SML_Signature periodSignature) {
		this.valTime = valTime;
		this.status = status;
		this.value_List = value_List;
		this.periodSignature = periodSignature;
	...
	protected void createElements() {
		...
		this.value_List = new List_of_SML_ValueEntry();
		this.periodSignature = new SML_Signature();
