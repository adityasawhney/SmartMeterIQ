...
public class SML_SetProcParameterReq extends Sequence {
	...
	public SML_SetProcParameterReq(OctetString serverId, OctetString username,
			OctetString password, SML_TreePath parameterTreePath,
	...
	protected void createElements() {
		...
		this.username = new OctetString();
		this.password = new OctetString();
		this.parameterTreePath = new SML_TreePath();
		this.parameterTree = new SML_Tree();
