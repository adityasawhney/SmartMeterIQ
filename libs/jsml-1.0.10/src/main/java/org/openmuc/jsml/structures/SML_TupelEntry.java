...
public class SML_TupelEntry extends Sequence {
	...
	public SML_TupelEntry(OctetString serverId, SML_Time secIndex, Unsigned64 status, SML_Unit unitPA,
		...
		this.status = status;
		this.unit_pA = unitPA;
		this.scaler_pA = scalerPA;
		this.value_pA = valuePA;
		this.unit_R1 = unitR1;
		this.scaler_R1 = scalerR1;
		this.value_R1 = valueR1;
		this.unit_R4 = unitR4;
		this.scaler_R4 = scalerR4;
		this.value_R4 = valueR4;
		this.signature_pA_R1_R4 = signaturePAR1R4;
		this.unit_mA = unitMA;
		this.scaler_mA = scalerMA;
		this.value_mA = valueMA;
		this.unit_R2 = unitR2;
		this.scaler_R2 = scalerR2;
		this.value_R2 = valueR2;
		this.unit_R3 = unitR3;
		this.scaler_R3 = scalerR3;
		this.value_R3 = valueR3;
		this.signature_mA_R2_R3 = signatureMAR2R3;
