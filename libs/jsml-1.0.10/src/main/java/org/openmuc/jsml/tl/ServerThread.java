...
/**
 * This class extends Thread. It is started by SML_TSAP and listens on a socket
 * for connections and hands them to the ConnectionHandler class. It notifies
 * ConnectionListener if the socket is closed.
 * 
