...
set title "Basic OV Chip gate protocol, superfast multiplication (4 attributes, RSA exponent)"

set pointsize 1.5
#pngset pointsize 1

plot \
     "mont-shortcut-h3-wired.gate-data" using 2:8 t 'prove, step 1', \
     "mont-shortcut-h3-wired.gate-data" using 2:9 t 'prove, step 2', \
     "mont-shortcut-h3-wired.gate-data" using 2:5 t 'prove, total time'
