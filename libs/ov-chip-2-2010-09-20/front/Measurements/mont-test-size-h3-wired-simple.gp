...
set key left
set xlabel "RSA key size in bits"
set xrange [0 : ]
set xtics 32,32
set yrange [0 : ]
...
set title "Basic OV Chip protocols (4 bases), Java only"

set pointsize 1.5
#pngset pointsize 1

plot \
     "mont-test-size-h3-wired.resign-data" using 2:($5 / 60) t 'resign', \
     "mont-test-size-h3-wired.gate-data" using 2:($5 / 60) t 'prove'
