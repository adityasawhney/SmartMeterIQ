...
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
//# 1 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/gui/../bignat/Bignat.java"
//# 1 "<built-in>"
//# 1 "<command-line>"
//# 1 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/gui/../bignat/Bignat.java"
// 
...
/// mode: c
/// End:
//# 28 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/gui/../bignat/Bignat.java" 2

//# 1 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/gui/../bignat/bignatconfig" 1
// 
// OV-chip 2.0 project
// 
// Digital Security (DS) group at Radboud Universiteit Nijmegen
...
//# 34 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/gui/../bignat/bignatconfig"
  // Let bignat operate on bytes, using short for multiplication results.
//# 45 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/gui/../bignat/bignatconfig"
/// Local Variables:
/// mode: c
/// End:
//# 30 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/gui/../bignat/Bignat.java" 2
...
//# 243 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/gui/../bignat/Bignat.java"
    /**
    ...
    public byte[] as_byte_array() {
            ...
            return value;
//# 323 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/gui/../bignat/Bignat.java"
    }



       private final short size;
//# 361 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/gui/../bignat/Bignat.java"
      /**
    ...
    private static short shift_bits(short high,
                                                ...
                                                short shift)
    {
//# 746 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/gui/../bignat/Bignat.java"
        // shift high
        high <<= shift;
        ...
        high |= bits;
//# 772 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/gui/../bignat/Bignat.java"
        if(shift <= digit_len) {
...
//# 918 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/gui/../bignat/Bignat.java"
    /**
...
//# 1025 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/gui/../bignat/Bignat.java"
...
//# 1055 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/gui/../bignat/Bignat.java"
...
//# 1083 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/gui/../bignat/Bignat.java"
                }
                else {
                    ...
                    divisor_digit =
                        shift_bits(first_divisor_digit,
                                   ...
                                   third_divisor_digit,
                                   bit_shift);
//# 1122 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/gui/../bignat/Bignat.java"
                }
...
//# 1136 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/gui/../bignat/Bignat.java"
     ...
     *               than {@link #bignat_base}.
     */
//# 1349 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/gui/../bignat/Bignat.java"
    /**
     * Scaled addition.
...
//# 1490 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/gui/../bignat/Bignat.java"
...
//# 1662 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/gui/../bignat/Bignat.java"
        short correction_factor; // used & initialized in the loop
        this.zero();
        for(short i = (short)(size -1); i >= 2; i--) {
//# 1677 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/gui/../bignat/Bignat.java"
             this.times_add(x, (short)(y.value[i] & digit_mask));
     ...
     * @param mod modulus, first two digits must be zero
     */
//# 1873 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/gui/../bignat/Bignat.java"
    /**
...
//# 2604 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/gui/../bignat/Bignat.java"
    /**
...
//# 2655 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/gui/../bignat/Bignat.java"
    /**
