...
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
//# 1 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/gui/../bignat/Host_modulus.java"
//# 1 "<built-in>"
//# 1 "<command-line>"
//# 1 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/gui/../bignat/Host_modulus.java"
// 
...
/// mode: c
/// End:
//# 26 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/gui/../bignat/Host_modulus.java" 2
    ...
    implements APDU_Serializable
{
    ...
    public Host_modulus(int bignat_size) {
        ...
        apdu_last_digit_inverse =
            new APDU_short((short)last_digit_inverse);
    ...
    public Host_modulus(int bignat_size, BigInteger m) {
        ...
        apdu_m.value = m;
        apdu_last_digit_inverse.value = (short)last_digit_inverse;
    }
