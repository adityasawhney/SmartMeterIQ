...
plot "rsa-exp-exp-200-h5-wired.data" using 2:8 t '200 bit exponent', \
     "rsa-exp-exp-512-h5-wired.data" using 2:8 t '512 bit exponent', \
     "rsa-exp-exp-1024-h5-wired.data" using 2:8 t '1024 bit exponent', \
     "rsa-exp-exp-1536-h5-wired.data" using 2:8 t '1024 bit exponent', \
     "rsa-exp-exp-1952-h5-wired.data" using 2:8 t '1952 bit exponent'