...
set title "Squared multiplication"
...
plot "squared-mult-h4-wired.data" using 2:6 t 'squared multiplication, wired', \
     "squared-mult-h3-wired.data" using 2:6 t 'squared multiplication, wired', \
     "add-h4-wired.data" using 2:3 t 'addition, wired', \
     "rsa-exp-fixed-exp-2-h3-wired.data" using 2:8 t 'squareing, wired'


#     "add-h4-wired.data" using 2:(6 * $3) t 'addition, wired', \
#     "rsa-exp-fixed-exp-2-h3-wired.data" using 2:(3 * $8) t 'squareing, wired'
#     "subtract-h3-wired.data" using 2:3 t 'addition, wired', \
