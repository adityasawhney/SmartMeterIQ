...
plot \
     "vector-squared-rsa-exp-base-4-h3-wired.data-without-first" using 2:5 \
                     t '4 bases, squared 2' smooth sbezier with lines, \
     "vector-squared-4-rsa-exp-base-4-h3-wired.data-without-first" using 2:5 \
                     t '4 bases, squared 4' smooth sbezier with lines
