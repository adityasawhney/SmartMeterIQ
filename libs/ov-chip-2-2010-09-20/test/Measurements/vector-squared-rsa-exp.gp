...
set title "multi exponent via RSA encryption and squared multiplication"

set pointsize 1.5
#pngset pointsize 1

plot \
     "vector-squared-rsa-exp-base-4-h4-wired.data" using 2:5 \
                     t '4 bases, wired', \
     "vector-squared-rsa-exp-base-4-h3-wireless.data" using 2:5 \
                     t '4 bases, wireless', \
