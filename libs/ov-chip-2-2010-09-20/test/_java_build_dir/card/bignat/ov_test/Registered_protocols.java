...
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
//# 1 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/test/../util/Registered_protocols.java"
//# 1 "<built-in>"
//# 1 "<command-line>"
//# 1 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/test/../util/Registered_protocols.java"
// 
...
/// mode: c
/// End:
//# 26 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/test/../util/Registered_protocols.java" 2
 ...
 class Registered_protocols {
    ...
    private void check_protocols() {
        for(short i = 0; i < max_protocol_index; i++) {
            Misc.myassert(protocols[i] != null, (short)(0));
            Protocol p = protocols[i];
            Misc.myassert(p.protocol_id == i, (short)(0));
            Misc.myassert(p.steps != null, (short)(0));
            for(short j = 0; j < p.steps.length; j++) {
                Protocol_step s = p.steps[j];
                Misc.myassert(s != null, (short)(0));
                if(s.arguments != null) {
                    for(short k = 0; k < s.arguments.length; k++) {
                        Misc.myassert(s.arguments[k] != null, (short)(0));
                    }
                }
                if(s.results != null) {
                    for(short k = 0; k < s.results.length; k++) {
                        Misc.myassert(s.results[k] != null, (short)(0));
                    }
                }
            }
        }
