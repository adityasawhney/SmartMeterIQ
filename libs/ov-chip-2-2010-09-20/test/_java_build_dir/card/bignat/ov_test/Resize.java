 ...
 */
 class Resize {
    ...
    public static void register_short_bignat(Bignat b) {
        Misc.myassert(short_bignats != null && short_bignat_index < max_short_bignats, (short)(0));
    ...
    public static void register_long_bignat(Bignat b) {
        ...
        Misc.myassert(long_bignats != null && long_bignat_index < max_long_bignats, (short)(0));
    ...
    public static void register_double_bignat(Bignat b) {
        //System.out.format("RLB %d\n", long_bignat_index);
        Misc.myassert(double_bignats != null && double_bignat_index < max_double_bignats, (short)(0));
    ...
    public static void register_vector(Vector v) {
        Misc.myassert(vectors != null && vector_index < max_vectors, (short)(0));
    ...
    public static void register_factor(Vector v) {
        Misc.myassert(factors != null && factor_index < max_factors, (short)(0));
       ...
       public static void register_long_rsa(RSA_exponent e) {
           Misc.myassert(long_rsa != null && long_rsa_index < max_long_rsa, (short)(0));
