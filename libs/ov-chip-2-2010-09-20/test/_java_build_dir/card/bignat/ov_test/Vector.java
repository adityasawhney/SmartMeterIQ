...
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
//# 1 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/test/../bignat/Vector.java"
//# 1 "<built-in>"
//# 1 "<command-line>"
//# 1 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/test/../bignat/Vector.java"
// 
...
/// mode: c
/// End:
//# 26 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/test/../bignat/Vector.java" 2
...
/// mode: c
/// End:
//# 28 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/test/../bignat/Vector.java" 2


  package ov_test;
//# 43 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/test/../bignat/Vector.java"
/** 
    ...
    implements APDU_Serializable
{
     ...
     */
    private Bignat[] temp;
//# 146 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/test/../bignat/Vector.java"
    /**
     * 
            ...
            while(bit != 0) {
                // square akku
                   ...
                   temp[(short)(1-t)].montgomery_mult(temp[t], temp[t],
                                                      modulus);
//# 388 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/test/../bignat/Vector.java"
                t = (short)(1-t);
    ...
    {
        Misc.myassert(this.length == exponent.length, (short)(0));
...
//# 536 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/test/../bignat/Vector.java"
            t = (short)((short)(t + 1) % 3);
    ...
    {
        Misc.myassert(this.length == exponent.length, (short)(0));
        Misc.myassert(this.length >= 1, (short)(0));
        Misc.myassert(temp != null, (short)(0));
...
//# 657 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/test/../bignat/Vector.java"
...
//# 720 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/test/../bignat/Vector.java"
        return false;
    }
}
