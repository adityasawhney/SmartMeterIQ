...
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
//# 1 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/test/../bignat/Bignat.java"
//# 1 "<built-in>"
//# 1 "<command-line>"
//# 1 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/test/../bignat/Bignat.java"
// 
...
/// mode: c
/// End:
//# 28 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/test/../bignat/Bignat.java" 2
...
/// mode: c
/// End:
//# 30 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/test/../bignat/Bignat.java" 2
 ...
 */
 class Bignat implements APDU_Serializable {
...
//# 243 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/test/../bignat/Bignat.java"
    /**
...
//# 280 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/test/../bignat/Bignat.java"
    /**
     * Digit array.
    ...
    public byte[] as_byte_array() {
            ...
            return value;
//# 323 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/test/../bignat/Bignat.java"
    }
       ...
       */
       ...
       void resize(short new_size) {
           Misc.myassert((new_size % size_multiplier == 0) && ((short)(new_size / size_multiplier) <= value.length), (short)(0x20));


           size = (short)(new_size / size_multiplier);
       }
//# 371 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/test/../bignat/Bignat.java"
    /**
...
//# 451 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/test/../bignat/Bignat.java"
    /**
    ...
    public void copy(Bignat other) {
        ...
        if(this.size >= other.size) {
           ...
           for(short i = 0; i < other_start; i++)
               Misc.myassert(other.value[i] == 0, (short)(0x21));
    ...
    public boolean same_value(Bignat other) {
        Misc.myassert(this.size == other.size, (short)(0x22));
    ...
    public boolean subtract(Bignat other) {
        short i, j;
            ...
            for(i = 0; i < (short)(other.size - this.size); i++) {
                Misc.myassert(other.value[i] == 0, (short)(0x23));
            }
    ...
    public void modular_subtraction(Bignat other, Modulus mod) {
        if(subtract(other)) {
            if(!add_carry(mod.m)) {
                ...
                // something is wrong.
                Misc.myassert(false, (short)(0x24));
            }
        }
        return;
    }
    ...
    public void times_minus(Bignat other, short shift, short mult) {
        ...
        Misc.myassert(akku == 0, (short)(0)); // otherwise we have an underflow

        // check if superfluous digits in other are zero

           while(j >= 0) {
               Misc.myassert(other.value[j] == 0, (short)(0));
               j--;
           }
    ...
    private static short shift_bits(short high,
                                                ...
                                                short shift)
    {
//# 746 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/test/../bignat/Bignat.java"
        // shift high
        high <<= shift;
        ...
        high |= bits;
//# 772 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/test/../bignat/Bignat.java"
        if(shift <= digit_len) {
    ...
    public boolean shift_lesser(Bignat other, short shift, short start) {
        short j;
           ...
           for(short i = 0; i < j; i++) {
               Misc.myassert(other.value[i] == 0, (short)(0x25));
           }
           // If j is negative, then this is longer than other and
           // -j digits are missing at the start of other.
           for(short i = 0; i < start; i++, j++) {
               Misc.myassert(this.value[i] == 0, (short)(0x26));
               if(j >= 0) {
                   Misc.myassert(other.value[j] == 0, (short)(0x27));
               }
           }
...
//# 918 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/test/../bignat/Bignat.java"
    /**
...
//# 1025 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/test/../bignat/Bignat.java"
...
//# 1055 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/test/../bignat/Bignat.java"
...
//# 1083 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/test/../bignat/Bignat.java"
                }
                else {
                    ...
                    divisor_digit =
                        shift_bits(first_divisor_digit,
                                   ...
                                   third_divisor_digit,
                                   bit_shift);
//# 1122 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/test/../bignat/Bignat.java"
                }
...
//# 1136 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/test/../bignat/Bignat.java"
                ...
                if(quotient != null) {
                    ...
                    Misc.myassert(divisor_shift < quotient.size, (short)(0x28));
                    ...
                    quotient_digit = (short)
                        ((quotient.value[(short)(quotient.size - 1 -
                          ...
                          & digit_mask)
                         + multiple);
                    Misc.myassert(quotient_digit < bignat_base, (short)(0));
                    quotient.value[(short)(quotient.size - 1 -
                                           divisor_shift)] =
                        (byte)(quotient_digit);
                }
    ...
    {
        Misc.myassert(this.size >= other.size, (short)(0x29));
        short akku = 0;
    ...
    public void add(Bignat other) {
        if(add_carry(other)) {
            Misc.myassert(false, (short)(0x2A));
        }
    }
    ...
    public void times_add(Bignat other, short mult) {
        Misc.myassert(this.size == other.size, (short)(0x2B));
        short akku = 0;
        ...
        Misc.myassert(akku == 0, (short)(0)); // otherwise we have an overflow
        return;
    }
     ...
     *               than {@link #bignat_base}.
     */
//# 1349 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/test/../bignat/Bignat.java"
    /**
     * Scaled addition.
                                ...
                                short mult)
    {
        ...
        Misc.myassert(this.size >= (short)(other.size + shift + 1), (short)(0x2D));
        short akku = 0;
        ...
        this.value[j] = (byte)(akku & digit_mask);
        // assert no overflow
        Misc.myassert(((akku >> digit_len) & digit_mask) == 0, (short)(0));
        return;
    }
    ...
    public void mult(Bignat x, Bignat y) {
        ...
        Misc.myassert(this.size >= (short)(x.size + y.size), (short)(0x2E));
    ...
    public void shift_left() {
        Misc.myassert(value[0] == 0, (short)(0));
    ...
    public void mult_mod(Bignat x, Bignat y, Bignat mod) {
        Misc.myassert(this.size == x.size && this.size == mod.size, (short)(0x2F));
        Misc.myassert(x.value[0] == 0 && x.value[1] == 0 && mod.value[0] == 0 && mod.value[1] == 0, (short)(0));
...
//# 1490 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/test/../bignat/Bignat.java"
    ...
    public void shift_right() {
        Misc.myassert(value[(short)(size -1)] == 0, (short)(0));
    ...
    public void montgomery_factor(Bignat mod, Bignat mont_fac) {
        Misc.myassert(this.size == mod.size && this.size == mont_fac.size, (short)(0x30));
        mont_fac.zero();
    ...
    public void montgomery_mult(Bignat x, Bignat y, Modulus mod) {
        Misc.myassert(this.size == x.size && this.size == y.size && this.size == mod.m.size, (short)(0x31));


        // x, y and mod must have at most size - 2 digits.
        Misc.myassert(x.value[0] == 0 && x.value[1] == 0 && y.value[0] == 0 && y.value[1] == 0 && mod.m.value[0] == 0 && mod.m.value[1] == 0, (short)(0));
//# 1662 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/test/../bignat/Bignat.java"
        short correction_factor; // used & initialized in the loop
        this.zero();
        for(short i = (short)(size -1); i >= 2; i--) {
//# 1677 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/test/../bignat/Bignat.java"
             this.times_add(x, (short)(y.value[i] & digit_mask));
     ...
     * @param mod modulus, first two digits must be zero
     */
//# 1873 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/test/../bignat/Bignat.java"
    /**
    ...
    public void demontgomerize(Modulus mod) {
        Misc.myassert(this.size == mod.m.size, (short)(0x33));
        // this and mod must have at most size - 2 digits.
        Misc.myassert(this.value[0] == 0 && this.value[1] == 0 && mod.m.value[0] == 0 && mod.m.value[1] == 0, (short)(0));
    ...
    {
        Misc.myassert(this.size == base.size && this.size == modulus.m.size && this.size == mont_one.size && this.size == temp.size, (short)(0x34));



        Misc.myassert(base.value[0] == 0 && base.value[1] == 0 && modulus.m.value[0] == 0 && modulus.m.value[1] == 0, (short)(0));
                                         ...
                                         Bignat temp_1, Bignat temp_2)
    {
        ...
        square_exp.fixed_power(temp_1, temp_2, (short)0);
        if(subtract(temp_2)) {
            Misc.myassert(false, (short)(0x35));
        }
        ...
        square_exp.fixed_power(temp_1, temp_2, (short)0);
        if(subtract(temp_2)) {
            Misc.myassert(false, (short)(0x36));
        }

        // 5: this = ((x + y)^2 - x^2 - y^2) / 2 = x*y
        Misc.myassert((this.value[(short)(this.size - 1)] & 0x01) == 0, (short)(0x37));
        div_2();
        return;
    }
    ...
    public void modular_div_4(Modulus mod) {
        Misc.myassert(mod.mod_x_2 != null && mod.mod_x_3 != null, (short)(0x38));
                                         ...
                                         Bignat temp_1, Bignat temp_2)
    {
        ...
        if(subtract(temp_2)) {
            Misc.myassert(false, (short)(0x39));
        }

        // 6: this = ((x + y)^2 - (x - y)^2) / 4 = x*y
        Misc.myassert((this.value[(short)(this.size - 1)] & 0x03) == 0, (short)(0x3A));
        div_4();
        return;
    }
    ...
    public byte get_first_digit_mask(short first_digit_index) {
           ...
           for(short i = 0; i < first_digit_index; i++) {
               Misc.myassert(this.value[i] == 0, (short)(0));
           }
     ...
     */
    public void rand_mod(RandomData rand, Bignat mod,
                         ...
                         byte first_digit_mask)
    {
        ...
        Misc.myassert(this.size == mod.size, (short)(0x3B));
     ...
     */
       ...
       public short to_byte_array(short len, short this_index,
           ...
           Misc.myassert(this_index < this.size, (short)(0));
           short max =
...
//# 2604 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/test/../bignat/Bignat.java"
    /**
...
//# 2655 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/test/../bignat/Bignat.java"
    /**
     ...
     */
//# 2675 "/tmp/tews/ov-dist/ov-chip-2-2010-09-20/test/../bignat/Bignat.java"
}
